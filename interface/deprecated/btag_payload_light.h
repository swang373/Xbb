...
float mistag_CSVL(float eta, float x, float scale) {
  ...
  // Atagger == "CSVL" && sEtamin == "0.0" && sEtamax == "0.5"
  if (eta > 0.0 && eta <= 0.5) {
  ...
  // Atagger == "CSVL" && sEtamin == "0.5" && sEtamax == "1.0"
  if (eta > 0.5 && eta <= 1.0) {
  ...
  // Atagger == "CSVL" && sEtamin == "1.0" && sEtamax == "1.5"
  if (eta > 1.0 && eta <= 1.5) {
  ...
  // Atagger == "CSVL" && sEtamin == "1.5" && sEtamax == "2.4"
  if (eta > 1.5 && eta <= 2.4) {
  ...
  if (scale > 0) {
    return mean + (max-mean)*scale;
  } else if (scale < 0) {
    return mean + (mean-min)*scale;
  } else {
    return mean;
  }
}
...
float mistag_CSVM(float eta, float x, float scale) {
  ...
  // Atagger == "CSVM" && sEtamin == "0.0" && sEtamax == "0.8"
  if (eta > 0.0 && eta <= 0.8) {
  ...
  // Atagger == "CSVM" && sEtamin == "0.8" && sEtamax == "1.6"
  if (eta > 0.8 && eta <= 1.6) {
  ...
  // Atagger == "CSVM" && sEtamin == "1.6" && sEtamax == "2.4"
  if (eta > 1.6 && eta <= 2.4) {
...
float mistag_CSVT(float eta, float x, float scale) {
  ...
  // Atagger == "CSVT" && sEtamin == "0.0" && sEtamax == "2.4"
  if (eta > 0.0 && eta <= 2.4) {
