...
TFile *_file0 = TFile::Open("mytreeData.root");
...
//tree->SetBranchStatus("HLT_BIT_HLT_DiPFJetAve60_v",1);
//tree->SetBranchStatus("HLT_BIT_HLT_DiPFJetAve40_v",1);


//TFile *_tmpFile = TFile::Open("tmp.root","recreate");
//TTree* tree = (TTree*) tree->CopyTree("(HLT_BIT_HLT_Ele23_WPLoose_Gsf_v)");

tree->Draw("(ntrgObjects_hltQuadJet15>=0):Jet_pt[0]+Jet_pt[1]+Jet_pt[2]  >> h(100,0,400)"," ( HLT_BIT_HLT_Ele23_WPLoose_Gsf_v)  ","prof,B");
...
tree->Draw("(ntrgObjects_hltQuadJet15>=4):Jet_pt[3] >> h(80,0,160)"," (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v) && (ntrgObjects_hltQuadJet15>=0)","prof");
...
tree->Draw("(ntrgObjects_hltTripleJet50>=3):Jet_pt[2] >> h(80,0,160)"," (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=0) ","prof");
...
tree->Draw("(ntrgObjects_hltDoubleJet65>=2):Jet_pt[1] >> h(80,0,160)"," (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=0) ","prof");
...
tree->Draw("(ntrgObjects_hltSingleJet80>=1):Jet_pt[0] >> h(80,0,160)"," (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=2) && (ntrgObjects_hltSingleJet80>=0) ","prof");
...
//tree->Draw("(ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=4):MaxIf$(offJet_eta,Jet_pt>30)-MinIf$(offJet_eta,Jet_pt>30) >> h(100,0,5)"," (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=2) && (ntrgObjects_hltSingleJet80>=1) && (ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=0) && Mqq_single>250","prof");
//h->GetYaxis()->SetTitle("Efficiency");h->SetTitle("");
...
tree->Draw("(ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=4):Detaqq_eta:Mqq_eta >> h(160,0,800,120,0,6)"," (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v ) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=2) && (ntrgObjects_hltSingleJet80>=1) && (ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=0)","prof,COLZ");
...
tree->Draw("(ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=4):Mqq_eta >> h(20,0,800)"," (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v ) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=2) && (ntrgObjects_hltSingleJet80>=1) && (ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=0) && Detaqq_eta>1.6","prof,COLZ");
h->GetYaxis()->SetTitle("#Delta#eta (qq)");h->SetTitle("Calo VBF cut turn-on");
h->GetXaxis()->SetTitle("M (qq)");
//TF2* tn2D_eta = (TF2*) turnon2D->Clone("tn2D_eta");
...
tree->Draw("(ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=4):Detaqq_eta >> h(60,0,6)"," (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v ) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=2) && (ntrgObjects_hltSingleJet80>=1) && (ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=0) && Mqq_eta>1.6","prof,COLZ");
h->GetYaxis()->SetTitle("#Delta#eta (qq)");h->SetTitle("Calo VBF cut turn-on");
h->GetXaxis()->SetTitle("M (qq)");
//TF2* tn2D_eta = (TF2*) turnon2D->Clone("tn2D_eta");
//tn2D_eta->SetRange(0,0,4,400);
...
tree->Draw("ntrgObjects_hltCSVL30p74>0:-log(1-Max$(Jet_btagCSV)) >> h(60,0,6)","(HLT_BIT_HLT_Ele23_WPLoose_Gsf_v) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=2) && (ntrgObjects_hltSingleJet80>=1) && (ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=4) && (ntrgObjects_hltCSVL30p74>=0) ","prof");
...
tree->Draw("(ntrgObjects_hltPFQuadJetLooseID15>=4):Jet_pt[3] >> h(80,0,160)"," (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=2) && (ntrgObjects_hltSingleJet80>=1) && (ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=4) && (ntrgObjects_hltCSVL30p74>=1) && (ntrgObjects_hltPFQuadJetLooseID15>=0) ","prof");
...
tree->Draw("(ntrgObjects_hltPFTripleJetLooseID64>=3):Jet_pt[2] >> h(80,0,160)"," (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=2) && (ntrgObjects_hltSingleJet80>=1) && (ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=4) && (ntrgObjects_hltCSVL30p74>=1) && (ntrgObjects_hltPFQuadJetLooseID15>=4) && (ntrgObjects_hltPFTripleJetLooseID64>=0)","prof");
...
tree->Draw("(ntrgObjects_hltPFDoubleJetLooseID76>=2):Jet_pt[1] >> h(80,0,160)"," (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=2) && (ntrgObjects_hltSingleJet80>=1) && (ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=4) && (ntrgObjects_hltCSVL30p74>=1) && (ntrgObjects_hltPFQuadJetLooseID15>=4) && (ntrgObjects_hltPFTripleJetLooseID64>=3) && (ntrgObjects_hltPFDoubleJetLooseID76>=0)","prof");
...
//tree->Draw("pfJet_ntrgObjects_hltCSVPF0p78>0:Jet_btagCSV[pfJet_offmatch] >> h(100,0,1)","pfJet_offmatch>=0 && (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=2) && (ntrgObjects_hltSingleJet80>=1) && (ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=4) && (ntrgObjects_hltCSVL30p74>=1) && (ntrgObjects_hltPFQuadJetLooseID15>=4) && (ntrgObjects_hltPFTripleJetLooseID64>=3) && (ntrgObjects_hltPFDoubleJetLooseID76>=2) && (ntrgObjects_hltPFSingleJetLooseID92>=1) ","prof");
//h->GetYaxis()->SetTitle("Efficiency");h->SetTitle("");
//h->GetXaxis()->SetTitle("CSV");
//c1->SaveAs("PFCSV1.png");
//c1->SaveAs("PFCSV1.C");

//tree->Draw("pfJet_ntrgObjects_hltDoubleCSVPF0p58>0:Jet_btagCSV[pfJet_offmatch] >> h(100,0,1)","pfJet_offmatch>=0 && (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=2) && (ntrgObjects_hltSingleJet80>=1) && (ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5e>=4) && (ntrgObjects_hltCSVL30p74>=1) && (ntrgObjects_hltPFQuadJetLooseID15>=4) && (ntrgObjects_hltPFTripleJetLooseID64>=3) && (ntrgObjects_hltPFDoubleJetLooseID76>=2) && (ntrgObjects_hltPFSingleJetLooseID92>=1) ","prof");
//h->GetYaxis()->SetTitle("Efficiency");h->SetTitle("");
//h->GetXaxis()->SetTitle("CSV");
...
tree->Draw("ntrgObjects_hltDoubleCSVPF0p58>=2:-log(1-MaxIf$(Jet_btagCSV,Jet_btagCSV!=Max$(Jet_btagCSV))) >> h(60,0,6)","(HLT_BIT_HLT_Ele23_WPLoose_Gsf_v) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=2) && (ntrgObjects_hltSingleJet80>=1) && (ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=4) && (ntrgObjects_hltCSVL30p74>=1) && (ntrgObjects_hltPFQuadJetLooseID15>=4) && (ntrgObjects_hltPFTripleJetLooseID64>=3) && (ntrgObjects_hltPFDoubleJetLooseID76>=2) && (ntrgObjects_hltPFSingleJetLooseID92>=1) && (ntrgObjects_hltDoubleCSVPF0p58>=0) ","prof");
...
tn2D_double->SetRange(0,0,8,800);
...
tree->Draw("(ntrgObjects_hltVBFPFJetCSVSortedMqq460Detaqq4p1>=4):Detaqq_1b:Dphibb_1b >> h(16,0,3.2,10,0,6)"," (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=2) && (ntrgObjects_hltSingleJet80>=1) && (ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=4) && (ntrgObjects_hltCSVL30p74>=1) && (ntrgObjects_hltPFQuadJetLooseID15>=4) && (ntrgObjects_hltPFTripleJetLooseID64>=3) && (ntrgObjects_hltPFDoubleJetLooseID76>=2) && (ntrgObjects_hltPFSingleJetLooseID92>=1) && (ntrgObjects_hltCSVPF0p78>=1) && (ntrgObjects_hltVBFPFJetCSVSortedMqq460Detaqq4p1>=0)","prof,COLZ");
...
//tree->Draw("(ntrgObjects_hltVBFPFJetCSVSortedMqq460Detaqq4p1>=4):Detaqq_1b >> h(50,0,10)"," (HLT_BIT_HLT_Ele23_WPLoose_Gsf_v) && (ntrgObjects_hltQuadJet15>=4) && (ntrgObjects_hltTripleJet50>=3) && (ntrgObjects_hltDoubleJet65>=2) && (ntrgObjects_hltSingleJet80>=1) && (ntrgObjects_hltVBFCaloJetEtaSortedMqq150Deta1p5>=4) && (ntrgObjects_hltCSVL30p74>=1) && (ntrgObjects_hltPFQuadJetLooseID15>=4) && (ntrgObjects_hltPFTripleJetLooseID64>=3) && (ntrgObjects_hltPFDoubleJetLooseID76>=2) && (ntrgObjects_hltPFSingleJetLooseID92>=1) && (ntrgObjects_hltCSVPF0p78>=1) && (ntrgObjects_hltVBFPFJetCSVSortedMqq460Detaqq4p1>=0) && Dphibb_1b<1.5 ","prof");
//h->GetYaxis()->SetTitle("Efficiency");h->SetTitle("");
//h->GetXaxis()->SetTitle("#Delta #phi (bb)");
