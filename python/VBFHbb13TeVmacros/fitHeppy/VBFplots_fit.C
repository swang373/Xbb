...
/*
tree->Draw("(ntrgObjects_hltQuadJet15>=1):Jet_pt[0]+Jet_pt[1]+Jet_pt[2]  >> h(100,0,400)"," ( HLT_BIT_HLT_Ele23_WPLoose_Gsf_v && Alt$(Jet_pt[3],0)>30)  ","prof");
