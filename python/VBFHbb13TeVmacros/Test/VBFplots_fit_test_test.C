...
//    tree->Draw("2"," DoubleBtagVBFTriggerWeight(30, 30, 30, 30, 0.9, 0.9, 3000,30, 30, 3000)*(1)","");
    tree->Draw("bMqq_eta  >> h(25,0,2000)"," test(offJet_pt[0], offJet_pt[1], offJet_pt[2], Max$(min(offJet_csv,1)), MaxIf$(min(offJet_csv,1),min(offJet_csv,1)!=Max$(min(offJet_csv,1))), bMqq_eta,bDetaqq_eta, bDetaqq_double, Mqq_double)*((HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2)&& (hltQuadJet15>=4) && (hltTripleJet50>=3) && (hltDoubleJet65>=2) && (hltSingleJet80>=1) && (hltVBFCaloJetEtaSortedMqq150Deta1p5>=0))","");
    h = (TProfile*) gDirectory->Get("h");h->SetLineColor(kBlack);h->SetMaximum(2.0*h->GetMaximum());
    tree->Draw("bMqq_eta"," 1.0001*((HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2)&& (hltQuadJet15>=4) && (hltTripleJet50>=3) && (hltDoubleJet65>=2) && (hltSingleJet80>=1) && (hltVBFCaloJetEtaSortedMqq150Deta1p5>=4))","same");

    c1->SaveAs("check_full_Mqq_test.png");
    c1->SaveAs("check_full_Mqq_test.C");

    tree->Draw("bDetaqq_eta  >> h(50,0,10)"," test(offJet_pt[0], offJet_pt[1], offJet_pt[2], Max$(min(offJet_csv,1)), MaxIf$(min(offJet_csv,1),min(offJet_csv,1)!=Max$(min(offJet_csv,1))), bMqq_eta,bDetaqq_eta, bDetaqq_double, Mqq_double)*((HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2)&& (hltQuadJet15>=4) && (hltTripleJet50>=3) && (hltDoubleJet65>=2) && (hltSingleJet80>=1) && (hltVBFCaloJetEtaSortedMqq150Deta1p5>=0))","");
    h = (TProfile*) gDirectory->Get("h");h->SetLineColor(kBlack);h->SetMaximum(2.0*h->GetMaximum());
    tree->Draw("bDetaqq_eta"," 1.0001*((HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2)&& (hltQuadJet15>=4) && (hltTripleJet50>=3) && (hltDoubleJet65>=2) && (hltSingleJet80>=1) && (hltVBFCaloJetEtaSortedMqq150Deta1p5>=4))","same");
