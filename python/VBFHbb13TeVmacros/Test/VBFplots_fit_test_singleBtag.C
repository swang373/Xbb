...
//    gROOT->SetBatch();
    ...
    tree->Draw("bMqq_single  >> h(25,0,2000)"," SingleBtagVBFTriggerWeight(offJet_pt[0], offJet_pt[1], offJet_pt[2], offJet_pt[3], Max$(min(offJet_csv,1)), bDetaqq_eta,bMqq_eta, bDphibb_single, bDetaqq_single)*(HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2)","");
    ...
    tree->Draw("Mbb_single  >> h(50,0,500)"," SingleBtagVBFTriggerWeight(offJet_pt[0], offJet_pt[1], offJet_pt[2], offJet_pt[3], Max$(min(offJet_csv,1)), bDetaqq_eta,bMqq_eta, bDphibb_single, bDetaqq_single)*(HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2)","");
    h = (TProfile*) gDirectory->Get("h");h->SetLineColor(kBlack);h->SetMaximum(2.0*h->GetMaximum());
    ...
    tree->Draw("bDetaqq_single  >> h(50,0,10)"," SingleBtagVBFTriggerWeight(offJet_pt[0], offJet_pt[1], offJet_pt[2], offJet_pt[3], Max$(min(offJet_csv,1)), bDetaqq_eta,bMqq_eta, bDphibb_single, bDetaqq_single)*(HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2)","");
    h = (TProfile*) gDirectory->Get("h");h->SetLineColor(kBlack);h->SetMaximum(2.0*h->GetMaximum());
    ...
    tree->Draw("bDphibb_single  >> h(32,0,3.2)"," SingleBtagVBFTriggerWeight(offJet_pt[0], offJet_pt[1], offJet_pt[2], offJet_pt[3], Max$(min(offJet_csv,1)), bDetaqq_eta,bMqq_eta, bDphibb_single, bDetaqq_single)*(HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2)","");
    h = (TProfile*) gDirectory->Get("h");h->SetLineColor(kBlack);h->SetMaximum(2.0*h->GetMaximum());
    ...
    tree->Draw("Max$(offJet_csv)  >> h(40,0,1)"," SingleBtagVBFTriggerWeight(offJet_pt[0], offJet_pt[1], offJet_pt[2], offJet_pt[3], Max$(min(offJet_csv,1)), bDetaqq_eta,bMqq_eta, bDphibb_single, bDetaqq_single)*(HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2)","");
    h = (TProfile*) gDirectory->Get("h");h->SetLineColor(kBlack);h->SetMaximum(2.0*h->GetMaximum());
    ...
    tree->Draw("MaxIf$(offJet_csv,offJet_csv!=Max$(offJet_csv))  >> h(40,0,1)"," SingleBtagVBFTriggerWeight(offJet_pt[0], offJet_pt[1], offJet_pt[2], offJet_pt[3], Max$(min(offJet_csv,1)), bDetaqq_eta,bMqq_eta, bDphibb_single, bDetaqq_single)*(HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2)","");
    h = (TProfile*) gDirectory->Get("h");h->SetLineColor(kBlack);h->SetMaximum(2.0*h->GetMaximum());
