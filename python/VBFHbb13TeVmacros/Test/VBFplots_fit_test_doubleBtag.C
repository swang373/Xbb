...
//    tree->Draw("2"," DoubleBtagVBFTriggerWeight(30, 30, 30, 30, 0.9, 0.9, 3000,30, 30, 3000)*(1)","");
    tree->Draw("bMqq_double  >> h(25,0,2000)"," DoubleBtagVBFTriggerWeightBeta(offJet_pt[0], offJet_pt[1], offJet_pt[2], Max$(min(offJet_csv,1)), MaxIf$(min(offJet_csv,1),min(offJet_csv,1)!=Max$(min(offJet_csv,1))), bDetaqq_eta,bMqq_eta, bDetaqq_double, Mqq_double)*((HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2))","");
    ...
    tree->Draw("Mbb_double  >> h(50,0,500)"," DoubleBtagVBFTriggerWeightBeta(offJet_pt[0], offJet_pt[1], offJet_pt[2], Max$(min(offJet_csv,1)), MaxIf$(min(offJet_csv,1),min(offJet_csv,1)!=Max$(min(offJet_csv,1))), bDetaqq_eta,bMqq_eta, bDetaqq_double, Mqq_double)*((HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2))","");
    h = (TProfile*) gDirectory->Get("h");h->SetLineColor(kBlack);h->SetMaximum(2.0*h->GetMaximum());
    ...
    tree->Draw("bDetaqq_double  >> h(50,0,10)"," DoubleBtagVBFTriggerWeightBeta(offJet_pt[0], offJet_pt[1], offJet_pt[2], Max$(min(offJet_csv,1)), MaxIf$(min(offJet_csv,1),min(offJet_csv,1)!=Max$(min(offJet_csv,1))), bDetaqq_eta,bMqq_eta, bDetaqq_double, Mqq_double)*((HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2))","");
    h = (TProfile*) gDirectory->Get("h");h->SetLineColor(kBlack);h->SetMaximum(2.0*h->GetMaximum());
    ...
    tree->Draw("bDphibb_double  >> h(32,0,3.2)"," DoubleBtagVBFTriggerWeightBeta(offJet_pt[0], offJet_pt[1], offJet_pt[2], Max$(min(offJet_csv,1)), MaxIf$(min(offJet_csv,1),min(offJet_csv,1)!=Max$(min(offJet_csv,1))), bDetaqq_eta,bMqq_eta, bDetaqq_double, Mqq_double)*((HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2))","");
    h = (TProfile*) gDirectory->Get("h");h->SetLineColor(kBlack);h->SetMaximum(2.0*h->GetMaximum());
    ...
    tree->Draw("Max$(offJet_csv)  >> h(40,0,1)"," DoubleBtagVBFTriggerWeightBeta(offJet_pt[0], offJet_pt[1], offJet_pt[2], Max$(min(offJet_csv,1)), MaxIf$(min(offJet_csv,1),min(offJet_csv,1)!=Max$(min(offJet_csv,1))), bDetaqq_eta,bMqq_eta, bDetaqq_double, Mqq_double)*((HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2))","");
    h = (TProfile*) gDirectory->Get("h");h->SetLineColor(kBlack);h->SetMaximum(2.0*h->GetMaximum());
    ...
    tree->Draw("MaxIf$(offJet_csv,offJet_csv!=Max$(offJet_csv))  >> h(40,0,1)"," DoubleBtagVBFTriggerWeightBeta(offJet_pt[0], offJet_pt[1], offJet_pt[2], Max$(min(offJet_csv,1)), MaxIf$(min(offJet_csv,1),min(offJet_csv,1)!=Max$(min(offJet_csv,1))), bDetaqq_eta,bMqq_eta, bDetaqq_double, Mqq_double)*((HLT_DiPFJetAve60_v2 || HLT_DiPFJetAve40_v2))","");
    h = (TProfile*) gDirectory->Get("h");h->SetLineColor(kBlack);h->SetMaximum(2.0*h->GetMaximum());
