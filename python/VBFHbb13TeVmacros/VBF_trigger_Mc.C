...
tree->Draw("HLT_BIT_HLT_QuadPFJet_SingleBTagCSV_VBF_Mqq460_v:Dphibb_1b:Detaqq_1b >> h(160,0,8,32,0,3.2)","HLT_BIT_HLT_QuadPFJet_VBF_v","prof,COLZ")
h->SetTitle("");
...
tree->Draw("HLT_BIT_HLT_QuadPFJet_SingleBTagCSV_VBF_Mqq460_v:Detaqq_1b >> h(160,3,5)","HLT_BIT_HLT_QuadPFJet_VBF_v && Dphibb_1b<1.5","prof,COLZ")
h->SetTitle("");
h->GetXaxis()->SetTitle("#Delta #eta_{qq}");
h->Draw("COLZ");
...
tree->Draw("HLT_BIT_HLT_QuadPFJet_SingleBTagCSV_VBF_Mqq460_v:Dphibb_1b >> h(160,1,2)","HLT_BIT_HLT_QuadPFJet_VBF_v && Detaqq_1b>4.2","prof,COLZ")
h->SetTitle("");
...
tree->Draw("HLT_BIT_HLT_QuadPFJet_SingleBTagCSV_VBF_Mqq460_v:Mqq_1b >> h(40,0,2000)","HLT_BIT_HLT_QuadPFJet_VBF_v && Detaqq_1b>4.2 && Dphibb_1b<1.5 && CSV[0]>0.941","prof")
h->SetTitle("");
...
tree->Draw("HLT_BIT_HLT_QuadPFJet_SingleBTagCSV_VBF_Mqq460_v:-log(1-CSV[0]) >> h(40,0,8)","HLT_BIT_HLT_QuadPFJet_VBF_v && Detaqq_1b>4.2 && Dphibb_1b<1.5","prof")
h->SetTitle("");
...
tree->Draw("HLT_BIT_HLT_QuadPFJet_SingleBTagCSV_VBF_Mqq460_v:Mqq_1b:Detaqq_1b >> h(40,0,8,50,0,5000)","HLT_BIT_HLT_QuadPFJet_VBF_v && Dphibb_1b<1.5 && CSV[0]>0.941","prof,COLZ")
h->SetTitle("");
...
//tree->Draw("-log(1-CSV[0]) >> h2(50,0,8)", "HLT_BIT_HLT_QuadPFJet_VBF_v && Detaqq_1b>4.2 && Dphibb_1b<1.5 && Mqq_1b>650 && HLT_BIT_HLT_QuadPFJet_SingleBTagCSV_VBF_Mqq460_v")
