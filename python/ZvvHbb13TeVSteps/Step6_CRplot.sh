bash runAll.sh CR_Nothing ZvvHbb13TeV plot > & log/logPlotCR_Nothing &
bash runAll.sh CR_TTbar ZvvHbb13TeV plot > & log/logPlotCR_TTbar &
bash runAll.sh CR_WLight ZvvHbb13TeV plot > & log/logPlotCR_WLight &
bash runAll.sh CR_Wbb ZvvHbb13TeV plot > & log/logPlotCR_Wbb &
