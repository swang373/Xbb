...
#bash runAll.sh ZH ZvvHbb13TeV prep >& log/logPrepZH &
#bash runAll.sh WH ZvvHbb13TeV prep >& log/logPrepWH &
#bash runAll.sh WJetsHT100 ZvvHbb13TeV prep >& log/logPrepWJetsHT100 &
#bash runAll.sh WJetsHT200 ZvvHbb13TeV prep >& log/logPrepWJetsHT200 &
#bash runAll.sh WJetsHT400 ZvvHbb13TeV prep >& log/logPrepWJetsHT400 &
#bash runAll.sh WJetsHT600 ZvvHbb13TeV prep >& log/logPrepWJetsHT600 &
#bash runAll.sh ZJetsHT100 ZvvHbb13TeV prep >& log/logPrepZJetsHT100 &
#bash runAll.sh ZJetsHT200 ZvvHbb13TeV prep >& log/logPrepZJetsHT200 &
#bash runAll.sh ZJetsHT400 ZvvHbb13TeV prep >& log/logPrepZJetsHT400 &
#bash runAll.sh ZJetsHT600 ZvvHbb13TeV prep >& log/logPrepZJetsHT600 &
#bash runAll.sh TT ZvvHbb13TeV prep >& log/logPrepTT &
#bash runAll.sh T_s ZvvHbb13TeV prep >& log/logPrepT_s &
#bash runAll.sh T_t ZvvHbb13TeV prep >& log/logPrepT_t &
#bash runAll.sh T_tW ZvvHbb13TeV prep >& log/logPrepT_tW &
#bash runAll.sh Tbar_s ZvvHbb13TeV prep >& log/logPrepTbar_s &
#bash runAll.sh Tbar_t ZvvHbb13TeV prep >& log/logPrepTbar_t &
#bash runAll.sh Tbar_tW ZvvHbb13TeV prep >& log/logPrepTbar_tW &
#bash runAll.sh QCDHT100 ZvvHbb13TeV prep >& log/logPrepQCDHT100 &
#bash runAll.sh QCDHT250 ZvvHbb13TeV prep >& log/logPrepQCDHT250 &
#bash runAll.sh QCDHT500 ZvvHbb13TeV prep >& log/logPrepQCDHT500 &
#bash runAll.sh QCDHT1000 ZvvHbb13TeV prep >& log/logPrepQCDHT1000 &
