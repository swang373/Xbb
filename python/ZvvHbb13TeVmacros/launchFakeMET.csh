...
python launchFakeMET.py $source_'/Skim'$QCDHT100  $envFolder'/Fake'$QCDHT100'/'     >& logFakeQCDHT100 &
python launchFakeMET.py $source_'/Skim'$QCDHT200  $envFolder'/Fake'$QCDHT200'/'     >& logFakeQCDHT200 &
python launchFakeMET.py $source_'/Skim'$QCDHT300  $envFolder'/Fake'$QCDHT300'/'     >& logFakeQCDHT300 &
python launchFakeMET.py $source_'/Skim'$QCDHT500  $envFolder'/Fake'$QCDHT500'/'     >& logFakeQCDHT500 &
python launchFakeMET.py $source_'/Skim'$QCDHT700  $envFolder'/Fake'$QCDHT700'/'     >& logFakeQCDHT700 &
python launchFakeMET.py $source_'/Skim'$QCDHT1000 $envFolder'/Fake'$QCDHT1000'/'    >& logFakeQCDHT1000 &
python launchFakeMET.py $source_'/Skim'$QCDHT1500 $envFolder'/Fake'$QCDHT1500'/'    >& logFakeQCDHT1500 &
python launchFakeMET.py $source_'/Skim'$QCDHT2000 $envFolder'/Fake'$QCDHT2000'/'    >& logFakeQCDHT2000 &

python launchFakeMET.py $source_'/Skim'$QCDHT500 $envFolder'/FakeQCDTest/'    >& logFakeQCDTest &
