...
#        print "%-30s %-30s %7.3f +/- %7.3f   %7.3f +/- %7.3f  %7.3f +/- %7.3f" % (m.group(1), m.group(2), norm_p.getVal(), norm_p.getError(), norm_s.getVal(), norm_s.getError(), norm_b.getVal(), norm_b.getError())
        print "%-30s %-30s %7.3f +/- %7.3f   %7.3f +/- %7.3f  %7.3f   %7.3f" % (m.group(1), m.group(2), norm_p.getVal(), norm_p.getError(), norm_b.getVal(), norm_b.getError(), norm_b.getVal()/norm_p.getVal(),  norm_s.getVal()/norm_p.getVal())
    else:
        if errors:
