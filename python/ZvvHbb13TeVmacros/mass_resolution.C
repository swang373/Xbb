...
//=========  (Fri Jan 15 16:58:10 2016) by ROOT version6.02/05
   TCanvas *c1 = new TCanvas("c1", "c1",0,0,1280,768);
   gStyle->SetOptStat(0);
   c1->Range(70,-736.1751,170,6625.575);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   c1->SetGridx();
   ...
   HmassReg2->SetBinContent(0,673);
   HmassReg2->SetBinContent(1,198);
   HmassReg2->SetBinContent(2,254);
   HmassReg2->SetBinContent(3,317);
   HmassReg2->SetBinContent(4,377);
   HmassReg2->SetBinContent(5,474);
   HmassReg2->SetBinContent(6,574);
   HmassReg2->SetBinContent(7,691);
   HmassReg2->SetBinContent(8,883);
   HmassReg2->SetBinContent(9,1018);
   HmassReg2->SetBinContent(10,1250);
   HmassReg2->SetBinContent(11,1340);
   HmassReg2->SetBinContent(12,1688);
   HmassReg2->SetBinContent(13,1974);
   HmassReg2->SetBinContent(14,2297);
   HmassReg2->SetBinContent(15,2625);
   HmassReg2->SetBinContent(16,2964);
   HmassReg2->SetBinContent(17,3392);
   HmassReg2->SetBinContent(18,3846);
   HmassReg2->SetBinContent(19,4471);
   HmassReg2->SetBinContent(20,4731);
   HmassReg2->SetBinContent(21,4899);
   HmassReg2->SetBinContent(22,5354);
   HmassReg2->SetBinContent(23,5158);
   HmassReg2->SetBinContent(24,4896);
   HmassReg2->SetBinContent(25,4360);
   HmassReg2->SetBinContent(26,3837);
   HmassReg2->SetBinContent(27,3288);
   HmassReg2->SetBinContent(28,2762);
   HmassReg2->SetBinContent(29,2113);
   HmassReg2->SetBinContent(30,1629);
   HmassReg2->SetBinContent(31,1308);
   HmassReg2->SetBinContent(32,971);
   HmassReg2->SetBinContent(33,782);
   HmassReg2->SetBinContent(34,558);
   HmassReg2->SetBinContent(35,446);
   HmassReg2->SetBinContent(36,336);
   HmassReg2->SetBinContent(37,292);
   HmassReg2->SetBinContent(38,233);
   HmassReg2->SetBinContent(39,179);
   HmassReg2->SetBinContent(40,173);
   HmassReg2->SetBinContent(41,1544);
   HmassReg2->SetEntries(81155);
   HmassReg2->SetStats(0);
   
   TF1 *fit22 = new TF1("fit2","[0]*exp(-0.5*((x-[1])/[2])^2)*abs(x<=[1])+[0]*exp(-0.5*((x-[1])/[3])^2)*abs(x>[1])+[4]",95.85468,181.8488);
   ...
   fit22->SetParameter(0,4743.54);
   fit22->SetParError(0,24.97898);
   fit22->SetParLimits(0,0,0);
   fit22->SetParameter(1,124.2224);
   fit22->SetParError(1,0.140047);
   fit22->SetParLimits(1,0,0);
   fit22->SetParameter(2,13.81539);
   fit22->SetParError(2,0.1266232);
   fit22->SetParLimits(2,0,0);
   fit22->SetParameter(3,9.811937);
   fit22->SetParError(3,0.111973);
   fit22->SetParLimits(3,0,0);
   fit22->SetParameter(4,200.6584);
   fit22->SetParError(4,7.922588);
